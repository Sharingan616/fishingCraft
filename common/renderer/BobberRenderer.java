...
{
    private static final ResourceLocation resourceLoc = new ResourceLocation(FishingCraft.MODID+":textures/particles.png");
    ...
    public void doRender(EntityFishHook p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        try
        {
            ...
            if (p_76986_1_.field_146042_b.getCurrentEquippedItem() != null)
            {
                i = p_76986_1_.field_146042_b.getCurrentEquippedItem().getItem();
            }

            if (i == FCItems.woodenFishingRodWorm || i == FCItems.ironFishingRodWorm)
            {
            	b0 = 1;
            }

            if (i == FCItems.woodenFishingRodBG || i == FCItems.ironFishingRodBG)
            {
            	b0 = 2;
            }

            if (i == FCItems.woodenFishingRodFrogEggs || i == FCItems.ironFishingRodFrogEggs)
            {
            	b0 = 3;
            }

            if (i == FCItems.woodenFishingRodMorsel || i == FCItems.ironFishingRodMorsel)
            {
            	b0 = 4;
            }

            if (i == FCItems.woodenFishingRodSP || i == FCItems.ironFishingRodSP)
            {
            	b0 = 5;
            }
        }
        ...
        {
            System.out.println("----");
            System.out.println("Exception caught: " + e + ", caused by Fishing Craft. Please post this on the mod forum page.");
            e.printStackTrace();
            System.out.println("----");
        }
        ...
        if (p_76986_1_.field_146042_b != null)
        {
            ...
            //Black(original): tessellator.setColorOpaque_I(0);
